...
while True:
    try:
        ...
        # Get the specific tarifs in byte string. Select substring 10:19 convert to string and to
        # float. The 5th and 6th line of the telegram message is the Meter Reading electricity
        # delivered by client in 0,001 kWh.
        ...
        thelogger.log_application_event(type='error', message=constants.ERR_UNKNOWN_ERROR.format(
            message=error), notify_message=False)  # todo enalble notify_message when method has
